package GameObjects 
{
	...
	{		
		...
		public function get bulletStartX():Number{ return PosX + 40*Math.cos(cannon.rotation+30); }
		public function get bulletStartY():Number{ return PosY + 40*Math.sin(cannon.rotation+30); }
